...
time $GEM5_DIR/build/X86/gem5.opt -d /home/eng/s/sxs220196/CA_Project/Outputs_456/456TournamentBP4096_2048_8192_8192/ $GEM5_DIR/configs/example/se.py -c $BENCHMARK -o $ARGUMENT -I 5000000 --cpu-type=atomic --caches --l2cache --l1d_size=128kB --l1i_size=128kB --l2_size=1MB --l1d_assoc=2 --l1i_assoc=2 --l2_assoc=1 --cacheline_size=64
