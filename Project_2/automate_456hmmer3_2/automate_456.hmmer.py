...
rootoutput = '/home/eng/s/sxs220196/CA_Project/OutputsP3/Outputs_456_2'

runGem5_456hmmer = '/home/eng/s/sxs220196/CA_Project/benchmarks/456.hmmer/runGem5.sh'
runGem5template_456hmmer = '/home/eng/s/sxs220196/CA_Project/automate_456hmmer3_2/runGem5_456hmmer.sh'
...
def runconfigs():
	...
	for c in combos[len(combos)//2:]:
		tempfolder2 = '/456L1S_' + str(c[0]) + '_' + str(c[1]) + '_L2S_' + str(c[2]) + '_L1a_'+str(c[3]) + '_L2a_' + str(c[4]) + '_cbs_' + str(c[5])
		outloc2 = rootoutput + tempfolder2

		#edit the shell script of 456.hmmer before running subprocess
...
if __name__ == '__main__':
	...
	print("Running 2nd Set Of Cache Configurations on 456.hmmer")
	runconfigs()
